...
#os.system("pyuic5 -o ui_interface.py interface.ui")
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        ################################################################################################
        #self.ui.GaugeRPM.enableBarGraph = True

        #self.ui.GaugeRPM.valueNeedleSnapzone = 1

        ################################################################################################
        # Set gauge units
        ################################################################################################
        #self.ui.GaugeRPM.units = "red"

        ################################################################################################
        # Set minimum gauge value
        ################################################################################################
        #self.ui.GaugeRPM.minValue = 0
        ################################################################################################
        # Set maximum gauge value
        ################################################################################################
        #self.ui.GaugeRPM.maxValue = 200

        ################################################################################################
        # Set scale divisions
        ################################################################################################
        #self.ui.GaugeRPM.scalaCount = 20
        ...
        # Select gauge theme
        ################################################################################################
        #self.ui.GaugeRPM.setGaugeTheme(24)

        #self.ui.GaugeRPM.setCustomGaugeTheme(
        #    color1 = "#FF2B00",
        #    color2= "#821600",
        #    color3 = "#260600"
        #)
        ...
        #self.ui.GaugeRPM.setScalePolygonColor(
        #    color1 = "#fff",
        #    color2 = "#555"
        #)

        #self.ui.GaugeRPM.setNeedleCenterColor(
        #    color1 = "red"
        #)

        #self.ui.GaugeRPM.setOuterCircleColor(
        #    color1 = "red"
        #)

        #self.ui.GaugeRPM.setBigScaleColor("white")
        #self.ui.GaugeRPM.setFineScaleColor("red")
        ...
        QFontDatabase.addApplicationFont(os.path.join(os.path.dirname(__file__), 'fonts/ds_digital/DS-DIGIT.TTF') )

        self.ui.GaugeRPM.setValueFontFamily("DS-Digital")
        self.ui.GaugeRPM.setScaleFontFamily("DS-Digital")



        font_id = QFontDatabase.addApplicationFont('fonts/ds_digital/DS-DIGIT.TTF')
        font_family = QFontDatabase.applicationFontFamilies(font_id)

        custom_font = QFont(font_family)
        self.ui.NeedToDiscuss.setFont(custom_font)
        #self.ui.NeedToDiscuss.Dis("5")
    ...
    # SET NEEDLE COLOR
    ################################################################################################
        self.ui.GaugeRPM.setNeedleColor(219, 64, 64)

    ################################################################################################
    # SET NEEDLE COLOR ON DRAG
    ################################################################################################
        self.ui.GaugeRPM.setNeedleColorOnDrag(219, 64, 64)

    ################################################################################################
    # SET SCALE TEXT COLOR
    ################################################################################################
        self.ui.GaugeRPM.setScaleValueColor(255, 255, 255)


    ################################################################################################
    # SET VALUE DISPLAY COLOR
    ################################################################################################
        self.ui.GaugeRPM.setDisplayValueColor(255, 255, 255)

    ################################################################################################
    # SHOW HIDE VALUE TEXT
    ################################################################################################
        self.ui.GaugeRPM.setEnableValueText(True)
